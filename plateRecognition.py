        ...
        for candidate in plate['candidates']:
            ...
            if candidate["plate"][0:2].isdigit():
                if candidate["plate"][2:5].isalpha():
                    candidate["plate"] = candidate["plate"][:5] + candidate["plate"][5:].replace("o", "0").replace("O",
                                                                                                                   "0")
                    if (len(candidate["plate"][5:]) == 2 or len(candidate["plate"][5:]) == 3) and candidate["plate"][
                                                                                                  5:].isdigit():
                        candidate["matches_template"] = 1
                elif candidate["plate"][2:4].isalpha():
                    candidate["plate"] = candidate["plate"][:4] + candidate["plate"][4:].replace("o", "0").replace("O",
                                                                                                                   "0")

                    if (len(candidate["plate"][4:]) == 3 or len(candidate["plate"][4:]) == 4) and candidate["plate"][
                                                                                                  4:].isdigit():
                        candidate["matches_template"] = 1
